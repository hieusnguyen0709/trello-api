...
const INVITATION_COLLECTION_SCHEMA = Joi.object({
  ...
  type: Joi.string().required().valid(...Object.values(INVITATION_TYPES)), // Kiểu lời mời
...
const deleteManyByBoardId = async (boardId) => {
  try {
    const result = await GET_DB().collection(INVITATION_COLLECTION_NAME).deleteMany({
...
const findPendingBoardInvitation = async (inviteeId, boardId) => {
  try {
